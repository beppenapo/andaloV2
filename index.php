    ...
    <div id="mainSection">
      ...
      <div class="container mt-2 mb-5">
        <div class="row">
          <div class="col">
            <p class="pt-2 mainText text-justify">
              Il <strong>Progetto Memoria - Fototeca documentaria dell'Altopiano della Paganella</strong> è stato reso possibile grazie al finanziamento dalla <strong>Fondazione Cassa di Risparmio di Trento e Rovereto</strong> (bando 2016). La realizzazione della banca dati e dei sistemi informatici di gestione e visualizzazione delle informazioni raccolte è frutto del lavoro della <strong> <a href="http://www.cooptesto.it/" title="home page [link esterno]" target="_blank">Cooperativa TeSto</a></strong> (Alberto Cosner) e di <strong> <a href="http://www.arc-team.com" title="home page [link esterno]" target="_blank">Arc-Team</a></strong> (Giuseppe Naponiello). I ricercatori che hanno partecipato al progetto sono stati numerosi: Angelo Longo (Cooperativa TeSto), Alessia Zeni, Anna Beber, Cinzia Perlot, Erika Maines, Filippo Frizzera, Giuliano Mattarelli, Martina Mottes, Jacopo Osti. Vanno inoltre ringraziate la <strong>Fondazione Museo storico del Trentino</strong>, la <strong>Comunità di Primiero e della Alta Valsugana e Bersntol</strong>: parte del codice informatico del database è derivato dal progetto <strong><a href="http://www.lefontiperlastoria.it/" title="home page [link esterno]" target="_blank">Fonti per la storia</a> e dall' <a href="http://www.altavalsugana.paesaggiocomunita.it/" title="home page [link esterno]" target="_blank">Archivio iconografico dei paesaggi di Comunità</a></strong>.
            </p>
          </div>
        </div>
