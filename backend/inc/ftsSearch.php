...
//echo 'ci: '.$ci.' cf: '.$cf.' tipo: '.$tipo.' liv: '.$liv.' vect: '.$vect.' filtro: '.$filtro.' fts: '.$q;
...
WHERE scheda.fine = 2 and ((crono.cro_iniz between $ci and $cf) or (crono.cro_fin between $ci and $cf)) $tipi $livelli) a
$whereFts
order by numsch asc;
");
