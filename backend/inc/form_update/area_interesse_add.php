        ...
        <tr>
            <td style="padding:0px !important;">
                ...
                <select id="aa" name="aa" class="form" style="width:220px !important;">
                    <?php 
                        if($tipoScheda==10){
                            $opt = "<option value='14'>-- seleziona area di interesse cartografico --</option>";
                            $t=3;
                            $defVal = $dv;
                        }else{
                            $opt = "<option value='14'>-- seleziona area di interesse --</option>";
                            $t=1;
                            $defVal = $dv;
                        }
            ...
            <td style="padding:0px 0px 0px 5px!important;">
                ...
                <select id="mu" name="mu" class="form">
                    <option value="3">Non determinabile</option>
                    <?php
